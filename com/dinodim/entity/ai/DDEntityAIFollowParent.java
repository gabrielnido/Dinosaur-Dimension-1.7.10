...
public class DDEntityAIFollowParent extends EntityAIBase
{
    /** The child that is following its parent. */
	EntityAgeable childAnimal;
    EntityAgeable parentAnimal;
    double field_75347_c;
    private int field_75345_d;

    public DDEntityAIFollowParent(EntityAgeable p_i1626_1_, double p_i1626_2_)
    {
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            EntityAgeable entityanimal = null;
            double d0 = Double.MAX_VALUE;
            Iterator iterator = list.iterator();

            while (iterator.hasNext())
            {
                EntityAgeable entityanimal1 = (EntityAgeable)iterator.next();
