...
public class DDWorldChunkManager extends WorldChunkManager
{
	...
	public DDWorldChunkManager()
	{
		this.myBiomeCache = new BiomeCache(this);
		this.myBiomesToSpawnIn = new ArrayList<BiomeGenBase>();
		this.myBiomesToSpawnIn.add(DDBiomes.DDPlainsLow);
		this.myBiomesToSpawnIn.add(DDBiomes.DDPlainsHills);
		this.myBiomesToSpawnIn.add(DDBiomes.DDMountains);
		this.myBiomesToSpawnIn.add(DDBiomes.DDOcean);
		this.myBiomesToSpawnIn.add(DDBiomes.DDJungle);
	}

	public DDWorldChunkManager(long seed, WorldType worldType)
	{
		this();
		GenLayer[] agenlayer = DDGenLayer.makeTheWorld(seed);
		this.myGenBiomes = agenlayer[0];
		this.myBiomeIndexLayer = agenlayer[1];
	}

	public DDWorldChunkManager(World world)
	{
	...
	public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5) 
	{
		...
		for (int i = 0; i < par4 * par5; ++i) 
		{
			...
			else 
			{
				...
				par1ArrayOfBiomeGenBase[i] = DDBiomes.DDJungle;
			}
		}
